...
class Level:
    ...
    def run(self, player_score: list[int]):
        ...
        while True:
            ...
            self.level_text(14, f'fps: {clock.get_fps():.0f}', C_WHITE, (WIN_WIDTH - 67, WIN_HEIGHT - 35))
            self.level_text(14, f'entidades: {len(self.entity_list)}', C_WHITE, (WIN_WIDTH - 67, WIN_HEIGHT - 20))
            pygame.display.flip()
            # Collisions
